...
|---|---|---|
| [**z0**](https://github.com/MapleCity1314/z0) | Open-source Code Agent platform. Plan → Execute → Feedback, isolated Git branches per SubAgent (GitTree Model), checkpoint recovery. | TS · Next.js · Vercel |
| [**vite-browser**](https://www.npmjs.com/package/@presto1314w/vite-devtools-browser) | Vite runtime observation layer for agent workflows. HMR correlation, store-to-render tracing, mapped error diagnosis — no plugin required. The `observe` leg of an autonomous repair pipeline. | TS · Node.js |
| [**loome**](https://github.com/MapleCity1314/loome) | AI-generated creative video & visual effects. The project I care about most — where I go when I need to remember why I build things. | React · Tauri · Rust |
| [**CandyBomb**](https://github.com/MapleCity1314/candybomb) | Web3 educational game. Minesweeper-style risk/reward mechanics on Sepolia testnet, AI-assisted gameplay. | Next.js · Foundry · wagmi · Vercel AI SDK |
...
- `observe → patch → apply → verify` — autonomous repair pipelines
- Sandbox abstraction as unified execution primitive (vite-browser · z0 · Rust CLI)
